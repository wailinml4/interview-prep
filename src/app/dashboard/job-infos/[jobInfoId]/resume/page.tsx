import { JobInfoBackLink } from "@/components/job-infos/JobInfoBackLink"
import { canRunResumeAnalysis } from "@/lib/canRunResumeAnalysis"
...
async function SuspendedComponent({ jobInfoId }: { jobInfoId: string }) {
  if (!(await canRunResumeAnalysis())) return redirect("/dashboard/upgrade")
