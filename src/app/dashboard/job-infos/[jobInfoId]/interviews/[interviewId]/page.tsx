...
import { getInterviewIdTag, getInterviewJobInfoTag } from "@/lib/cache/interviews"
...
import { generateInterviewFeedback } from "@/lib/actions/interviews"
              ...
              i.feedback == null ? (
                ...
                <Dialog>
                  ...
                  <DialogContent className="md:max-w-3xl lg:max-w-4xl max-h-[calc(100%-2rem)] overflow-y-auto flex flex-col">
                    ...
                    <DialogDescription>
                      Interview feedback generated by AI for the selected session.
                    </DialogDescription>
  ...
  if (humeChatId == null) {
    return (
      <div className="max-w-5xl mx-auto text-center py-12">
        <p className="text-muted-foreground">No chat messages for this interview yet.</p>
      </div>
    )
  }
